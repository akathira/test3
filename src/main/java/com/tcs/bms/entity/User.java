...
public class User {
	...
	public User(Long id, String name, String password, String roles, String email, String address, String phone_number,
			int otpRetryCount, LocalDateTime lastOtpRequestTime, Account account) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", password=" + password + ", roles=" + role + ", email=" + email
				+ ", address=" + address + ", phone_number=" + phone_number + ", otpRetryCount=" + otpRetryCount
				+ ", lastOtpRequestTime=" + lastOtpRequestTime + ", account=" + account + "]";
	}
